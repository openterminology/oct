...
## Design Philosophy <kbd>[RFC](#rfc)</kbd>
...
## Namespace-Hierarchy Separation <kbd>[RFC](#rfc)</kbd>
...
## Community Contributions <kbd>[RFC](#rfc)</kbd>
...
## Decision-Making <kbd>[RFC](#rfc)</kbd>
...
## Commercial Use <kbd>[RFC](#rfc)</kbd>
...
## Future Foundation <kbd>[RFC](#rfc)</kbd>
...
## Use of AI/LLMs <kbd>[RFC](#rfc)</kbd>
...
A number of aspects of the project are still under discussion, these are labelled <kbd>[RFC](#rfc)</kbd>. GitHub Issues or [openhealthhub.org](https://openhealthhub.org/c/oct) may be used for discussion, and when consensus is reached these sections will be updated accordingly.
...
function OctopusApp() {
  ...
  function extractHierarchyData() {
    if (!result) return { parents: [], children: [] };
                  ...
                  <div style=${{ padding: '1rem', background: 'white', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                    ${hierarchyView === 'parents' && html`
                      <div style=${{ textAlign: 'center', padding: '3rem', color: '#6b7280' }}>
                        ...
                        <h4 style=${{ marginBottom: '0.5rem', color: '#374151' }}>Parent Concepts</h4>
                        <p style=${{ fontSize: '0.9rem', color: '#9ca3af' }}>
                          Shows direct parent concepts (superclasses) in the hierarchy
                        </p>
                      </div>
                    `}
                    ...
                    ${hierarchyView === 'children' && html`
                      <div style=${{ textAlign: 'center', padding: '3rem', color: '#6b7280' }}>
                        <div style=${{ fontSize: '3rem', marginBottom: '1rem' }}>⬇️</div>
                        <h4 style=${{ marginBottom: '0.5rem', color: '#374151' }}>Child Concepts</h4>
                        <p style=${{ fontSize: '0.9rem', color: '#9ca3af' }}>
                          Shows direct child concepts (subclasses) in the hierarchy
                        </p>
                      </div>
                    `}
                    ...
                    ${hierarchyView === 'tree' && html`
                      <div style=${{ textAlign: 'center', padding: '3rem', color: '#6b7280' }}>
                        ...
                        <h4 style=${{ marginBottom: '0.5rem', color: '#374151' }}>Full Hierarchy Tree</h4>
                        <p style=${{ fontSize: '0.9rem', color: '#9ca3af' }}>
                          Interactive tree visualization showing the complete concept hierarchy
                        </p>
                      </div>
                    `}
                  </div>
